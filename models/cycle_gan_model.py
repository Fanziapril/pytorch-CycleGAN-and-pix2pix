...
class CycleGANModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        if self.isTrain and opt.pre_train:
            which_epoch = 'latest'
            #dirA = '../Experiments/models/4_faces_pix2pix/'
            #dirB = '../Experiments/models/5_faces_pix2pix/'
            dirA = '../Experiments/models/10_faces_pix2pix/'
            dirB = '../Experiments/models/12_faces_pix2pix/'
    ...
    def get_current_errors(self):
        ...
        D_bat_A = self.loss_D_A_batch.data[0]
        if self.opt.identity > 0.0:
            idt_A = self.loss_idt_A.data[0]
            idt_B = self.loss_idt_B.data[0]
            return OrderedDict([('D_A', D_A), ('G_A', G_A), ('Cyc_A', Cyc_A), ('idt_A', idt_A), ('D_bat_A', D_bat_A),
                                ('D_B', D_B), ('G_B', G_B), ('Cyc_B', Cyc_B), ('idt_B', idt_B)])
        else:
            return OrderedDict([('D_A', D_A), ('G_A', G_A), ('Cyc_A', Cyc_A), ('D_bat_A', D_bat_A),
